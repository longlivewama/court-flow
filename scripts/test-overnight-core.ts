import { validateBookingSlot } from '../backend/src/domain/booking/booking.validator';
import { getBooking } from '../backend/src/interfaces/http/controllers/booking.controller';
import { db } from '../backend/src/infrastructure/database/client';
